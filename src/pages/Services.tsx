...
const Services = () => {
  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="py-20 bg-background">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold mb-4">Transportation Services</h2>
            ...
            {fleetTypes.map((vehicle, index) => (
              <Card key={index} className="text-center car-card">
                <CardContent className="p-6">
                  ...
                  <p className="text-sm text-muted-foreground mb-4">{vehicle.capacity}</p>
                  <div className="text-2xl font-bold text-primary mb-4">{vehicle.price}</div>
                  <div className="text-sm text-muted-foreground mb-4 italic">{vehicle.bestFor}</div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <Card className="dark-surface-elevated border-gray-700 p-6">
              <CardContent className="pt-6 text-center">
                <h3 className="text-xl font-semibold mb-4 text-white">Per Kilometer</h3>
                <div className="text-3xl font-bold text-primary mb-4">$0.50 - $2.00</div>
                <p className="text-soft mb-6">Based on vehicle type and distance</p>
            ...
            <Card className="dark-surface-elevated border-gray-700 p-6">
              <CardContent className="pt-6 text-center">
                <h3 className="text-xl font-semibold mb-4 text-white">Hourly Packages</h3>
                <div className="text-3xl font-bold text-primary mb-4">$15 - $40</div>
                <p className="text-soft mb-6">For multiple stops and waiting time</p>
                <ul className="text-sm text-soft space-y-2">
            ...
            <Card className="dark-surface-elevated border-gray-700 p-6">
              <CardContent className="pt-6 text-center">
                <h3 className="text-xl font-semibold mb-4 text-white">Fixed Packages</h3>
                <div className="text-3xl font-bold text-primary mb-4">$50 - $200</div>
                <p className="text-soft mb-6">For outstation and full-day trips</p>
                <ul className="text-sm text-soft space-y-2">
      ...
      <section className="py-20 bg-background">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-4xl font-bold mb-4">Ready to Experience Premium Transportation?</h2>
